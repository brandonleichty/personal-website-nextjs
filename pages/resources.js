      ...
      <main>
        ...
        <div className="uses-wrapper">
          <div className="resource-section-heading">
            <h3 className="mb-8 mt-16 text-5xl font-medium text-purple dark:text-baby-blue">
              Tutorial Sites
            </h3>
          ...
          <div className="resource-section-heading">
            ...
            <ul className="space-y-6 dark:text-favWhite">
              ...
              <li>
                <a
                  href="https://www.youtube.com/channel/UCmXVXfidLZQkppLPaATcHag"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Better Dev
              ...
              <li>
                <a
                  href="https://www.youtube.com/user/99baddawg"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Ben Awad
          ...
          <div className="resource-section-heading">
            ...
            <ul className="space-y-6 dark:text-favWhite">
              <li>
                <a
                  href="https://www.meetup.com/JavaScriptMN/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.masterywithsql.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Mastery with SQL
              ...
              <li>
                <a
                  href="https://weibenfalk.teachable.com/p/react-create-a-movie-app"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Weibenfalk's
          ...
          <div className="resource-section-heading">
            ...
            <ul className="space-y-6 dark:text-favWhite">
              ...
              <li>
                <a
                  href="https://nostarch.com/ecmascript6"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.amazon.com/Think-Like-Programmer-Introduction-Creative/dp/1593274246"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.amazon.com/Simplifying-JavaScript-Writing-Modern-Beyond/dp/1680502883"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.amazon.com/Effective-JavaScript-Specific-Software-Development/dp/0321812182"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.amazon.com/Rediscovering-JavaScript-Master-ES6-ES7/dp/1680505467"
                  target="_blank"
                  rel="noopener noreferrer"
                >
